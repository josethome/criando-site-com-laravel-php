<h2 class="mb-5"><strong>Solicitação bem sucedida!</strong></h2>
	...
	{{-- <p>Sua nova senha: <strong>{{ $dados['nova_senha'] }}</strong></p> --}}

	<p>Sua nova senha: <strong>{{ $nova_senha }}</strong></p>

	<p>No próximo login de acesso ao sistema, use a nova senha.</p>